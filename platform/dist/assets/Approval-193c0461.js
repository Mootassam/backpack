import{u as f,k as c,D as x,j as e,w as g}from"./index-9fb4ec24.js";function h(){const n=f(),l=()=>n.goBack(),[p,d]=c.useState(null);return c.useEffect(()=>{x.list(null,null,1,0).then(t=>{var r,i,o,s;const a=(s=(o=(i=(r=t==null?void 0:t.rows)==null?void 0:r[0])==null?void 0:i.certificate)==null?void 0:o[0])==null?void 0:s.downloadUrl;a&&d(a)}).catch(()=>{})},[]),e.jsxs("div",{className:"approval-page",children:[e.jsxs("div",{className:"approval-container",children:[e.jsxs("div",{className:"top-header",children:[e.jsx("div",{className:"back-button",onClick:l,children:e.jsx("i",{className:"fas fa-arrow-left"})}),e.jsx("h1",{className:"page-title",children:g("pages.profile.menu.msbApproval")}),e.jsx("div",{className:"header-placeholder"})]}),e.jsx("div",{className:"content-card",children:e.jsx("img",{src:p||"/images/certif.png",alt:"Certificate",className:"certificate-image"})})]}),e.jsx("style",{children:`
        .approval-page {
          min-height: 100vh;
