import{o as U,u as Ce,n as B,y as Fe,F as De,k as n,G as I,j as e,w as t,x as Te,X as ae}from"./index-9fb4ec24.js";import{S as ze}from"./sucessModal-24ee7dc1.js";import{u as Ue}from"./useDispatch-09756e97.js";const S=a=>a.assets.form,Pe=U([S],a=>a.record),Me=U([S],a=>!!a.initLoading),Ae=U([S],a=>!!a.saveLoading),Ee=U([S],a=>!!a.showModal),Le={selectInitLoading:Me,selectSaveLoading:Ae,selectRecord:Pe,selectModal:Ee,selectRaw:S},ie="bp_conversion_data",Re=5*60*1e3;function $e(){try{const a=localStorage.getItem(ie);if(!a)return null;const{data:g,ts:j}=JSON.parse(a);return Date.now()-j>Re?null:g}catch{return null}}function Be(a){try{localStorage.setItem(ie,JSON.stringify({data:a,ts:Date.now()}))}catch{}}function oe(a){const g=a.symbol,j=g.replace("USDT",""),m=parseFloat(a.lastPrice??a.c??"0"),k=Math.abs(Number(a.priceChangePercent??a.P??"0")).toFixed(2),o=!String(a.priceChangePercent??a.P??"0").startsWith("-");return{symbol:g,name:`${j}/USDT`,price:m.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:m<1?6:4}),changePercent:k,isPositive:o,quoteVolume:parseFloat(a.quoteVolume??a.q??"0"),numericPrice:m}}function Ve(){var se,ne;const a=Ue(),g=Ce(),j=B(Fe.selectCurrentUser),m=B(De.selectRows),k=B(Le.selectModal),[o,O]=n.useState("USDT"),[i,q]=n.useState("BTC"),[c,P]=n.useState(1),[C,V]=n.useState(0),[W,te]=n.useState(0),[re,F]=n.useState(!1),[ce,le]=n.useState("from"),[D,_]=n.useState(""),[de,M]=n.useState(!0),[H,pe]=n.useState(null),[x,A]=n.useState({}),[me,w]=n.useState(!1),[ue,J]=n.useState(0),[T,G]=n.useState(0),[y,K]=n.useState(!1),[E,xe]=n.useState({}),[h,X]=n.useState({}),b=n.useRef(null),z=n.useRef(new Map),N=n.useRef(null),L=n.useRef(!1);n.useEffect(()=>{a(I.doFetch())},[a]),n.useEffect(()=>{if(m!=null&&m.length){const s=m.reduce((r,d)=>(r[d.symbol]=d.amount,r),{});X(s)}},[m]),n.useEffect(()=>{(async()=>{const r=$e();r&&(A(r),M(!1));try{const u=(await Te.get("https://api.binance.com/api/v3/ticker/24hr")).data.filter(p=>p.symbol.endsWith("USDT")&&!p.symbol.includes("UP")&&!p.symbol.includes("DOWN")&&!p.symbol.includes("BEAR")&&!p.symbol.includes("BULL")).sort((p,f)=>parseFloat(f.quoteVolume)-parseFloat(p.quoteVolume)).slice(0,200),l={};u.forEach(p=>{l[p.symbol]=oe(p)}),l.USDT={symbol:"USDT",name:"USDT/USDT",price:"1.00",changePercent:"0.00",isPositive:!0,quoteVolume:0,numericPrice:1},A(l),Be(l),M(!1)}catch{r||pe("Failed to fetch market data. Please try again later."),M(!1)}})()},[]),n.useEffect(()=>{let s=!0;const r=()=>{if(N.current=null,!s||z.current.size===0)return;const d=Array.from(z.current.values());z.current.clear(),A(u=>{const l={...u};let p=!1;return d.forEach(f=>{l[f.s]&&(l[f.s]=oe({...f,priceChangePercent:f.P,lastPrice:f.c}),p=!0)}),p?l:u})};return b.current=new WebSocket("wss://stream.binance.com:9443/ws/!ticker@arr"),b.current.onmessage=d=>{if(!s)return;JSON.parse(d.data).forEach(l=>z.current.set(l.s,l)),N.current||(N.current=setTimeout(r,400))},b.current.onerror=()=>{},()=>{s=!1,N.current&&clearTimeout(N.current),b.current&&(b.current.close(),b.current=null)}},[]);const Y=n.useCallback(()=>{var u,l;if(L.current)return;const s=o==="USDT"?1:((u=x[`${o}USDT`])==null?void 0:u.numericPrice)??0,r=i==="USDT"?1:((l=x[`${i}USDT`])==null?void 0:l.numericPrice)??0;if(!s||!r)return;const d=s/r;te(d),V(c*d)},[o,i,c,x]);n.useEffect(()=>{Y()},[Y]);const Q=n.useMemo(()=>{const s=Object.values(x).map(r=>{const d=r.symbol.replace("USDT","")||"USDT";return{code:d,name:d,symbol:r.symbol,price:r.numericPrice}});return s.find(r=>r.code==="USDT")||s.push({code:"USDT",name:"USDT",symbol:"USDT",price:1}),s},[x]),fe=n.useMemo(()=>Q.filter(s=>s.code.toLowerCase().includes(D.toLowerCase())||s.name.toLowerCase().includes(D.toLowerCase())),[Q,D]),v=n.useMemo(()=>!o||c<=0?!1:c<=(h[o]??0),[c,o,h]),ge=n.useMemo(()=>c*.001,[c]),he=n.useMemo(()=>C-C*.001,[C]),R=o==="USDT"?1:((se=x[`${o}USDT`])==null?void 0:se.numericPrice)??null,Z=i==="USDT"?1:((ne=x[`${i}USDT`])==null?void 0:ne.numericPrice)??null,be=s=>{P(parseFloat(s.target.value)||0)},ve=()=>P(h[o]??0),je=s=>{ce==="from"?O(s):q(s),F(!1),_("")},ee=s=>{le(s),F(!0)},we=()=>{O(i),q(o)},ye=()=>{v&&(J(ge),G(he),w(!0))},Ne=()=>{a(ae.doClose()),P(1),V(0),G(0),J(0),a(I.doFetch())},Se=()=>{v&&(K(!0),L.current=!0,setTimeout(()=>{a(ae.doCreate({user:j.id,fromSymbol:o,fromAmount:c,toSymbol:i,coinName:i,toAmount:T.toFixed(8),status:"available"})),X(s=>({...s,[o]:(s[o]??0)-c,[i]:(s[i]??0)+T})),L.current=!1,K(!1),w(!1),setTimeout(()=>a(I.doFetch()),500)},1500))},$=s=>xe(r=>({...r,[s]:!0})),ke=()=>g.goBack();return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"conversion-page",children:[e.jsxs("div",{className:"top-header",children:[e.jsx("div",{className:"back-button",onClick:ke,children:e.jsx("i",{className:"fas fa-arrow-left"})}),e.jsx("h1",{className:"page-title",children:t("pages.conversion.title")}),e.jsx("div",{className:"header-placeholder"})]}),e.jsxs("div",{className:"conversion-card",children:[de&&e.jsxs("div",{className:"loading-overlay",children:[e.jsx("div",{className:"loading-spinner"}),e.jsx("span",{children:t("pages.conversion.loading")})]}),H&&e.jsxs("div",{className:"error-banner",children:[e.jsx("i",{className:"fas fa-exclamation-triangle"})," ",H]}),e.jsxs("div",{className:"input-section",children:[e.jsxs("div",{className:"input-header",children:[e.jsx("span",{className:"input-label",children:t("pages.conversion.youSend")}),e.jsxs("div",{className:"balance-row",children:[e.jsxs("span",{className:"balance-text",children:[t("pages.conversion.balance"),": ",h[o]??0," ",o]}),e.jsx("button",{className:"max-btn",onClick:ve,children:t("pages.conversion.max")})]})]}),e.jsxs("div",{className:"input-row",children:[e.jsx("input",{type:"number",value:c,onChange:be,placeholder:"0.0"}),e.jsxs("div",{className:"coin-selector",onClick:()=>ee("from"),children:[e.jsx("div",{className:"coin-icon",children:E[o]?e.jsx("span",{className:"icon-fallback",children:o.charAt(0)}):e.jsx("img",{src:`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${o}.png`,alt:o,loading:"lazy",onError:()=>$(o)})}),e.jsx("span",{className:"coin-code",children:o}),e.jsx("i",{className:"fas fa-chevron-down"})]})]}),R!==null&&e.jsxs("div",{className:"usd-price",children:["1 ",o," = $",R.toLocaleString("en-US",{maximumFractionDigits:2})]}),!v&&c>0&&e.jsxs("div",{className:"insufficient-warning",children:[e.jsx("i",{className:"fas fa-exclamation-circle"})," ",t("pages.conversion.insufficientBalance")]})]}),e.jsx("div",{className:"switch-wrapper",children:e.jsx("button",{className:"switch-btn",onClick:we,children:e.jsx("i",{className:"fas fa-exchange-alt"})})}),e.jsxs("div",{className:"input-section",children:[e.jsxs("div",{className:"input-header",children:[e.jsx("span",{className:"input-label",children:t("pages.conversion.youReceive")}),e.jsxs("span",{className:"balance-text",children:[t("pages.conversion.balance"),": ",h[i]??0," ",i]})]}),e.jsxs("div",{className:"input-row",children:[e.jsx("input",{type:"number",value:C.toFixed(8),readOnly:!0}),e.jsxs("div",{className:"coin-selector",onClick:()=>ee("to"),children:[e.jsx("div",{className:"coin-icon",children:E[i]?e.jsx("span",{className:"icon-fallback",children:i.charAt(0)}):e.jsx("img",{src:`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${i}.png`,alt:i,loading:"lazy",onError:()=>$(i)})}),e.jsx("span",{className:"coin-code",children:i}),e.jsx("i",{className:"fas fa-chevron-down"})]})]}),Z!==null&&e.jsxs("div",{className:"usd-price",children:["1 ",i," = $",Z.toLocaleString("en-US",{maximumFractionDigits:2})]})]}),e.jsxs("div",{className:"conversion-info",children:[e.jsxs("div",{className:"info-row",children:[e.jsx("span",{children:t("pages.conversion.estimatedConversion")}),e.jsxs("span",{className:"rate",children:["1 ",o," = ",W.toFixed(8)," ",i]})]}),e.jsxs("div",{className:"info-row",children:[e.jsx("span",{children:"USD Value"}),e.jsxs("span",{className:"usd-value",children:["$",(c*(R??0)).toLocaleString("en-US",{maximumFractionDigits:2})]})]})]}),e.jsx("button",{className:`convert-btn ${v&&c>0&&o!==i?"":"disabled"}`,onClick:ye,disabled:!v||c<=0||o===i,children:o===i?t("pages.conversion.selectDifferentCurrencies"):v?t("pages.conversion.convertNow"):t("pages.conversion.insufficientBalance")}),e.jsxs("div",{className:"update-notice",children:[e.jsx("i",{className:"fas fa-sync-alt"})," ",t("pages.conversion.pricesUpdate")]})]})]}),re&&e.jsx("div",{className:"currency-modal-overlay",onClick:()=>F(!1),children:e.jsxs("div",{className:"currency-modal-content",onClick:s=>s.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h3",{children:t("pages.conversion.selectCurrency")}),e.jsx("button",{className:"modal-close",onClick:()=>F(!1),children:e.jsx("i",{className:"fas fa-times"})})]}),e.jsxs("div",{className:"modal-search",children:[e.jsx("i",{className:"fas fa-search"}),e.jsx("input",{placeholder:t("pages.conversion.searchCurrencies"),value:D,onChange:s=>_(s.target.value)})]}),e.jsx("ul",{className:"modal-list",children:fe.map(s=>e.jsxs("li",{onClick:()=>je(s.code),children:[e.jsx("div",{className:"modal-coin-icon",children:E[s.code]?e.jsx("span",{className:"icon-fallback",children:s.code.charAt(0)}):e.jsx("img",{src:`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${s.code}.png`,alt:s.code,loading:"lazy",onError:()=>$(s.code)})}),e.jsxs("div",{className:"modal-coin-info",children:[e.jsx("span",{className:"coin-code",children:s.code}),e.jsx("span",{className:"coin-name",children:s.name})]}),e.jsxs("div",{className:"modal-coin-right",children:[e.jsxs("span",{className:"coin-price",children:["$",s.price.toLocaleString("en-US",{maximumFractionDigits:2})]}),e.jsxs("span",{className:"coin-balance",children:[t("pages.conversion.balance"),": ",h[s.code]??0]})]})]},s.code))})]})}),k&&e.jsx(ze,{isOpen:k,onClose:Ne,type:"convert",amount:Number(T).toFixed(8),coinType:i}),me&&e.jsx("div",{className:"confirmation-overlay",onClick:()=>!y&&w(!1),children:e.jsxs("div",{className:"confirmation-dialog",onClick:s=>s.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h3",{children:t("pages.conversion.confirmConversion")}),e.jsx("button",{className:"modal-close",onClick:()=>!y&&w(!1),children:e.jsx("i",{className:"fas fa-times"})})]}),e.jsxs("div",{className:"modal-body",children:[e.jsxs("div",{className:"swap-summary",children:[e.jsxs("div",{className:"swap-side",children:[e.jsx("span",{className:"swap-amount",children:c}),e.jsx("span",{className:"swap-currency",children:o})]}),e.jsx("i",{className:"fas fa-arrow-down swap-arrow"}),e.jsxs("div",{className:"swap-side",children:[e.jsx("span",{className:"swap-amount",children:T.toFixed(8)}),e.jsx("span",{className:"swap-currency",children:i})]})]}),e.jsxs("div",{className:"swap-details",children:[e.jsxs("div",{className:"detail-line",children:[e.jsx("span",{children:t("pages.conversion.exchangeRate")}),e.jsxs("span",{children:["1 ",o," = ",W.toFixed(8)," ",i]})]}),e.jsxs("div",{className:"detail-line",children:[e.jsx("span",{children:t("pages.conversion.networkFee")}),e.jsxs("span",{children:[ue.toFixed(8)," ",o]})]}),e.jsxs("div",{className:"detail-line",children:[e.jsx("span",{children:t("pages.conversion.estimatedArrival")}),e.jsx("span",{children:t("pages.conversion.arrivalTime")})]})]})]}),e.jsxs("div",{className:"modal-footer",children:[e.jsx("button",{className:"confirm-btn",onClick:Se,disabled:y,children:y?e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fas fa-spinner fa-spin"})," ",t("pages.conversion.processingConversion")]}):e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fas fa-check-circle"})," ",t("pages.conversion.confirmConversion")]})}),e.jsx("button",{className:"cancel-btn",onClick:()=>w(!1),disabled:y,children:t("pages.conversion.cancel")})]})]})}),e.jsx("style",{children:`
        .conversion-page {
          min-height: 100vh;
          background: #0e0f14;
          display: flex;
