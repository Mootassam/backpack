import{a3 as e,k as z,a4 as q,j as o}from"./index-2baf2db5.js";import{a as B,b as E}from"./FormErrors-fd731287.js";function g(t){const{label:i,description:f,name:r,hint:l,type:a,placeholder:x,autoFocus:m,autoComplete:b,required:h,externalErrorMessage:d,disabled:y,endAdornment:p,className:c}=t,[n,w]=z.useState(!1),{register:j,errors:v,formState:{touched:N,isSubmitted:C}}=B();d&&q.error(d);const u=E.errorMessage(r,v,N,C),F=()=>{w(!n)},k=a==="password"&&n?"text":a;return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"input-group",children:[!!i&&o.jsx("label",{className:`input-label ${h?"required":""}`,htmlFor:r,children:i}),f,o.jsxs("div",{className:"input-container",style:{position:"relative",...c==="captcha-input"?{padding:0}:{}},children:[o.jsx("input",{className:`${c||""} ${u?"__danger":""}`,id:r,name:r,type:k,ref:j,onChange:s=>{t.onChange&&t.onChange(s.target.value)},onBlur:s=>{t.onBlur&&t.onBlur(s)},placeholder:x||void 0,autoFocus:m||void 0,autoComplete:b||void 0,disabled:y,style:a==="password"?{paddingRight:"40px",width:"100%"}:{width:"100%"}}),a==="password"&&o.jsx("div",{className:"toggle-password",onClick:F,style:{position:"absolute",right:"12px",top:"50%",transform:"translateY(-50%)",cursor:"pointer",color:"#888",zIndex:2,background:"transparent",border:"none",padding:"8px"},children:o.jsx("i",{className:n?"far fa-eye-slash":"far fa-eye"})})]}),p&&o.jsx("div",{className:"input-group-append",children:o.jsx("span",{className:"input-group-text",children:p})}),o.jsx("div",{className:"invalid-feedback",children:u}),!!l&&o.jsx("small",{className:"form-text text-muted",children:l})]}),o.jsx("style",{children:`
        .input-group {
          width: 100%;
          margin-bottom: 0;
        }
