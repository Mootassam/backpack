import{k as o,u as M,j as a}from"./index-9fb4ec24.js";function I(){const[c,p]=o.useState(null),[n,h]=o.useState(!1),[f,t]=o.useState(!1),[l,d]=o.useState(!1),[g,r]=o.useState(!1),b=M(),j=[{src:"/playsotre/1.png",label:"Advanced Charts"},{src:"/playsotre/2.jpg",label:"Fast Withdrawals"},{src:"/playsotre/3.jpg",label:"Crypto Staking"},{src:"/playsotre/4.jpg",label:"Portfolio"},{src:"/playsotre/5.jpg",label:"Market"},{src:"/playsotre/6.jpg",label:"Future Trade"},{src:"/playsotre/5.png",label:"24/7 Support"}],u=e=>{p(e)},x=()=>{p(null)},v=()=>{t(!0)},N=async()=>{d(!0);try{const e="https://backspack.net/apk/backspack.apk",s=document.createElement("a");s.href=e,s.download="backspack.apk",document.body.appendChild(s),s.click(),document.body.removeChild(s),setTimeout(()=>{d(!1),t(!1)},2e3)}catch(e){console.error("Download failed:",e),d(!1)}},w=e=>{e.target.closest(".screenshot")||e.target.closest(".install-button")||e.target.closest(".share-button")||e.target.closest(".back-button")||t(!0)},i={title:"Backpack  Exchange - Crypto Trading App",text:"Check out Backpack  Exchange - The ultimate trading platform for cryptocurrency and forex markets. Trade Bitcoin, Ethereum, and more with advanced tools!",url:"https://backspack.net/playstore",apkUrl:"https://backspack.net/apk/backspack.apk"},k=()=>{const e=`${i.title}
