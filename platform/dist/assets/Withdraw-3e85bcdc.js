import{v as E,$ as xe,q as l,a0 as be,u as S,n as ge,F as ye,Y as Ne,p as a,G as ve,Z as je,a9 as ee,j as e,L as te,A as ke}from"./index-52cad42e.js";import{u as Se,y as Ce,c as re,F as Ae}from"./FormErrors-ab744f80.js";import{y as g}from"./yupFormSchemas-c51678b2.js";import{F as ne}from"./FieldFormItem-e06d258e.js";import{S as Fe}from"./sucessModal-f32d05f2.js";import{u as ze}from"./useDispatch-a8300b64.js";const C=o=>o.withdraw.form,De=E([C],o=>o.record),Ie=E([C],o=>!!o.initLoading),Re=E([C],o=>!!o.saveLoading),Me=E([C],o=>!!o.withdrawModal),ae={selectInitLoading:Ie,selectSaveLoading:Re,selectRecord:De,selectModal:Me,selectRaw:C},T=["USDT","ETH","BTC","USDC","DAI","SHIB","XRP","TRX","SOL","BNB","DOGE"],M=300,ie=5,Ee={USDT:2,ETH:6,BTC:8,USDC:2,DAI:2,SHIB:0,XRP:2,TRX:2,SOL:4,BNB:6,DOGE:2},Ue=xe().shape({orderNo:g.string(l("entities.withdraw.fields.orderNo")),currency:g.string(l("entities.withdraw.fields.currency")),withdrawAmount:be().typeError(l("pages.withdraw.errors.amountNumber")).required(l("pages.withdraw.errors.amountRequired")).test("positive",l("pages.withdraw.errors.amountPositive"),o=>typeof o=="number"&&o>0),fee:g.decimal(l("entities.withdraw.fields.fee")),totalAmount:g.decimal(l("entities.withdraw.fields.totalAmount")),auditor:g.relationToOne(l("entities.withdraw.fields.auditor")),acceptTime:g.datetime(l("entities.withdraw.fields.acceptTime")),status:g.enumerator(l("entities.withdraw.fields.status"),{options:["pending","canceled","success"]})});function Oe(){var K;const o=ze(),A=S(ge.selectCurrentUser),U=S(ye.selectRows)||[],V=S(ae.selectModal),h=S(Ne.selectRows),W=S(ae.selectSaveLoading),[oe,$]=a.useState(""),[Le,F]=a.useState(""),[r,L]=a.useState(""),[x,j]=a.useState(""),[_,H]=a.useState(null),[O,P]=a.useState(!1),[q,z]=a.useState(!1),[d,se]=a.useState({}),[D,X]=a.useState(!1);a.useEffect(()=>{o(ve.doFetch("exchange"))},[o]),a.useEffect(()=>{o(je.doFetch())},[o]),a.useEffect(()=>{const t=async()=>{try{X(!0);const i=await ke.get("https://min-api.cryptocompare.com/data/pricemulti",{params:{fsyms:T.join(","),tsyms:"USD"}});if(i.data&&i.data.Response!=="Error"){const w={};T.forEach(s=>{var Q;(Q=i.data[s])!=null&&Q.USD&&(w[s]=i.data[s].USD)}),se(w)}}catch(i){console.error("Failed to fetch exchange rates:",i)}finally{X(!1)}};t();const n=setInterval(t,5*60*1e3);return()=>clearInterval(n)},[]),a.useEffect(()=>{if(h&&h.length>0&&!r){const t=h[0],n=t.symbol||t.id;L(n),c.setValue("currency",n),t.network&&t.network.length>0&&j(t.network[0]._id||t.network[0].name)}},[h]),a.useEffect(()=>{var t,n;if(r&&U.length){const i=U.find(s=>String(s.symbol).toUpperCase()===String(r).toUpperCase());H(i||null);const w=((n=(t=A==null?void 0:A.wallet)==null?void 0:t[r])==null?void 0:n.address)||"";F(w),c.setValue("currency",r),w&&c.setValue("withdrawAdress",w)}else H(null),F(""),c.setValue("currency",""),c.setValue("withdrawAdress","")},[r,U,A]);const B={orderNo:"",currency:"",withdrawAmount:"",fee:"",totalAmount:"",auditor:"",acceptTime:"",status:"pending",withdrawAdress:""},c=Se({resolver:Ce.yupResolver(Ue),mode:"all",defaultValues:B}),ce=re({control:c.control,name:"withdrawAmount"});re({control:c.control,name:"currency"});const u=Number(ce),y=!Number.isNaN(u)&&isFinite(u),N=_&&Number(_.amount)||0,{minInCurrency:v,feeInCurrency:p}=a.useMemo(()=>{if(!r||!d[r])return{minInCurrency:0,feeInCurrency:0};const t=d[r],n=M/t,i=ie/t;return{minInCurrency:n,feeInCurrency:i}},[r,d]),I=a.useMemo(()=>!h||!r?null:h.find(t=>{const n=t.symbol||t.id||"";return String(n).toUpperCase()===String(r).toUpperCase()}),[h,r]),f=(I==null?void 0:I.network)||[];a.useEffect(()=>{if(f.length>0){const t=f[0];j(t._id||t.name),z(!1)}else j("")},[I,f]);const k=y?Math.max(u-p,0):0,m=a.useCallback((t,n)=>{if(typeof t!="number"||!isFinite(t)||t===0)return"0";const i=n!==void 0?n:Ee[r]||2;return t>0&&t<1e-6?t.toFixed(i>8?i:8):new Intl.NumberFormat("en-US",{minimumFractionDigits:0,maximumFractionDigits:i}).format(t)},[r]),b=a.useCallback(t=>typeof t!="number"||!isFinite(t)||t===0?"$0.00":t>0&&t<.01?`$${t.toFixed(6)}`:new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:2,maximumFractionDigits:6}).format(t),[]),G=a.useCallback(t=>`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${t?t.toUpperCase():""}.png`,[]),le=a.useCallback(t=>{j(t._id||t.name),z(!1)},[]),R=a.useCallback(()=>{if(!r)return{disabled:!0,label:l("pages.withdraw.validation.selectCurrency"),reason:"selectCurrency"};if(f.length>0&&!x)return{disabled:!0,label:l("pages.withdraw.validation.selectNetwork"),reason:"selectNetwork"};if(!y||u<=0)return{disabled:!0,label:l("pages.withdraw.validation.enterAmount"),reason:"enterAmount"};if(u<v){const n=m(v);return{disabled:!0,label:l("pages.withdraw.validation.belowMin",n,r),reason:"belowMin"}}if(u>N)return{disabled:!0,label:l("pages.withdraw.validation.insufficientBalance"),reason:"insufficientBalance"};if(u+p>N)return{disabled:!0,label:l("pages.withdraw.validation.insufficientForFee"),reason:"insufficientForFee"};const t=c.getValues("withdrawAdress");return!t||t.trim()===""?{disabled:!0,label:l("pages.withdraw.validation.enterAddress"),reason:"enterAddress"}:{disabled:!1,label:l("pages.withdraw.confirmWithdrawal"),reason:"ok"}},[r,f,x,y,u,v,N,p,c,m])(),de=a.useCallback(()=>{o(ee.doClose()),c.reset(B),L(""),F(""),$(""),j("")},[o,c,B]),we=a.useCallback(async t=>{if(!R.disabled)try{t.currency=r;const n=new Date,i=`${n.getFullYear()}${String(n.getMonth()+1).padStart(2,"0")}${String(n.getDate()).padStart(2,"0")}`,w=Math.floor(Math.random()*1e7).toString().padStart(7,"0");t.orderNo=`RE${i}${w}`;const s=Number(t.withdrawAmount)||0;t.fee=p,t.totalAmount=s-p,t.status="pending",t.network=x,$(t.totalAmount.toString()),await o(ee.doCreate(t))}catch(n){console.error("Withdrawal submission error:",n)}},[r,p,x,R.disabled,o]),pe=a.useCallback(t=>{const n=t.symbol||t.id;L(n),c.setValue("currency",n),c.setValue("withdrawAmount",""),c.setValue("withdrawAdress",""),P(!1),z(!1)},[c]),Y=a.useMemo(()=>!y||!d[r]?0:u*d[r],[u,r,d,y]),he=a.useMemo(()=>d[r]?p*d[r]:0,[p,r,d]),Z=a.useMemo(()=>d[r]?k*d[r]:0,[k,r,d]),ue=a.useMemo(()=>N===0?"0":m(N),[N,m]),J=a.useMemo(()=>v===0?"0":m(v),[v,m]),me=a.useMemo(()=>p===0?"0":m(p),[p,m]),fe=a.useMemo(()=>k===0?"0":m(k),[k,m]);return c.formState,e.jsxs("div",{className:"withdraw-container",children:[e.jsx("div",{className:"header",children:e.jsxs("div",{className:"nav-bar",children:[e.jsx(te,{to:"/wallets",className:"back-arrow",children:e.jsx("i",{className:"fas fa-arrow-left"})}),e.jsx("div",{className:"page-title",children:"Withdraw"}),e.jsx(te,{className:"header-icon",to:"/history",style:{color:"white"},children:e.jsx("i",{className:"fas fa-receipt"})})]})}),e.jsx("div",{className:"content-card",children:e.jsx("div",{className:"withdraw-content",children:e.jsxs("div",{className:"form-section",children:[e.jsxs("div",{className:"input-field",children:[e.jsx("label",{className:"input-label",children:"Select currency"}),e.jsxs("div",{className:"custom-select-wrapper",children:[e.jsxs("div",{className:"currency-select-trigger",onClick:()=>P(!O),children:[r?e.jsxs("div",{className:"selected-currency",children:[e.jsx("div",{className:"currency-icon",children:e.jsx("img",{src:G(r),alt:r,onError:t=>{const n=t.target;n.onerror=null,n.style.display="none";const i=n.parentElement;i&&(i.textContent=r.charAt(0),i.style.background="#f0f0f0",i.style.color="#333",i.style.fontSize="14px",i.style.fontWeight="bold",i.style.display="inline-flex",i.style.alignItems="center",i.style.justifyContent="center",i.style.width="24px",i.style.height="24px",i.style.borderRadius="50%")}})}),e.jsx("span",{className:"currency-text",children:r}),D?e.jsx("span",{className:"rate-loading",children:"Loading rates..."}):d[r]?e.jsxs("span",{className:"currency-rate",children:["(1 ",r," ≈ ",b(d[r]),")"]}):null]}):e.jsx("span",{className:"placeholder",children:"Select Currency"}),e.jsx("i",{className:"fas fa-chevron-down dropdown-arrow"})]}),O&&e.jsx("div",{className:"currency-dropdown",children:h&&h.length>0?h.filter(t=>T.includes(t.symbol||t.id)).map(t=>{const n=t.symbol||t.id;return e.jsxs("div",{className:"currency-option",onClick:()=>pe(t),children:[e.jsx("div",{className:"currency-icon",children:e.jsx("img",{src:G(n),alt:n,onError:i=>{const w=i.target;w.onerror=null,w.style.display="none";const s=w.parentElement;s&&(s.textContent=n.charAt(0),s.style.background="#f0f0f0",s.style.color="#333",s.style.fontSize="14px",s.style.fontWeight="bold",s.style.display="inline-flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.width="24px",s.style.height="24px",s.style.borderRadius="50%")}})}),e.jsx("span",{className:"currency-text",children:n}),D?e.jsx("span",{className:"rate-loading-small",children:"..."}):d[n]?e.jsxs("span",{className:"currency-rate-small",children:["(",b(d[n]),")"]}):null]},t.id||n)}):e.jsx("div",{className:"no-options",children:"No currencies available"})})]})]}),r&&d[r]&&e.jsx("div",{className:"info-box",children:e.jsxs("div",{className:"info-row",children:[e.jsx("span",{className:"info-label",children:"Minimum withdrawal:"}),e.jsxs("span",{className:"info-value",children:[J," ",r," (",b(M),")"]})]})}),r&&f.length>0&&e.jsxs("div",{className:"input-field",children:[e.jsx("label",{className:"input-label",children:"Withdraw network"}),e.jsxs("div",{className:"custom-select-wrapper",children:[e.jsxs("div",{className:"network-select-trigger",onClick:()=>z(!q),children:[e.jsxs("div",{className:"selected-network",children:[e.jsx("i",{className:"fas fa-network-wired network-icon"}),e.jsx("span",{className:"network-text",children:((K=f.find(t=>t._id===x||t.id===x||t.name===x))==null?void 0:K.name)||"Select Network"})]}),e.jsx("i",{className:"fas fa-chevron-down dropdown-arrow"})]}),q&&e.jsx("div",{className:"network-dropdown",children:f.map(t=>e.jsxs("div",{className:"network-option",onClick:()=>le(t),children:[e.jsx("i",{className:"fas fa-network-wired network-icon-small"}),e.jsx("span",{className:"network-text",children:t.name})]},t._id||t.id||t.name))})]})]}),e.jsx(Ae,{...c,children:e.jsxs("form",{onSubmit:c.handleSubmit(we),children:[e.jsxs("div",{className:"input-field",children:[e.jsx("label",{className:"input-label",children:"Withdraw address"}),e.jsx("div",{className:"input-wrapper",children:e.jsx(ne,{name:"withdrawAdress",type:"text",className:"address-field",placeholder:"Enter your wallet address",onChange:t=>F(t.target.value)})}),e.jsx("br",{})]}),e.jsxs("div",{className:"input-field",children:[e.jsx("label",{className:"input-label",children:"Amount of coins withdrawn"}),e.jsx("div",{className:"input-wrapper",children:e.jsx(ne,{name:"withdrawAmount",type:"number",className:"amount-field",placeholder:"0.0",step:"any"})}),e.jsxs("div",{className:"balance-info",children:[e.jsxs("div",{className:"balance-text",children:["Available: ",e.jsxs("span",{className:"balance-amount",children:[ue," ",r]})]}),y&&Y>0&&e.jsxs("div",{className:"usd-value",children:["≈ ",b(Y)]})]})]}),e.jsxs("div",{className:"fee-section",children:[e.jsxs("div",{className:"fee-row",children:[e.jsx("div",{className:"fee-label",children:"Withdrawal fee:"}),e.jsxs("div",{className:"fee-value",children:[me," ",r,e.jsxs("span",{className:"fee-usd",children:[" (",b(he),")"]})]})]}),e.jsxs("div",{className:"fee-row",children:[e.jsx("div",{className:"fee-label",children:"Minimum withdrawal:"}),e.jsxs("div",{className:"fee-value",children:[J," ",r,e.jsxs("span",{className:"fee-usd",children:[" (",b(M),")"]})]})]}),e.jsxs("div",{className:"fee-row",children:[e.jsx("div",{className:"fee-label",children:"You will receive:"}),e.jsxs("div",{className:"fee-value receive-amount",children:[fe," ",r,Z>0&&e.jsxs("span",{className:"receive-usd",children:[" (≈ ",b(Z),")"]})]})]})]}),e.jsxs("div",{className:"notice-section",children:[e.jsx("div",{className:"notice-title",children:"Important notice"}),e.jsxs("div",{className:"notice-content",children:[e.jsxs("div",{className:"notice-item",children:["1. Minimum withdrawal amount is $",M," USD equivalent in selected currency."]}),e.jsxs("div",{className:"notice-item",children:["2. Withdrawal fee is $",ie," USD equivalent in selected currency."]}),e.jsx("div",{className:"notice-item",children:"3. After submitting the withdraw application, the money will arrive within 24 hours. If the money does not arrive after the expected withdraw time, please consult the online customer service."}),e.jsx("div",{className:"notice-item",children:"4. After submitting the withdraw application, the funds are frozen because the withdraw is in progress and the funds are temporarily held by the system. This does not mean that you have lost the asset or that there is an abnormality with the asset."})]})]}),e.jsx("button",{type:"submit",className:"withdraw-button",disabled:R.disabled||W||D,children:W?e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fas fa-spinner fa-spin",style:{marginRight:"8px"}}),"Processing..."]}):D?e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fas fa-spinner fa-spin",style:{marginRight:"8px"}}),"Loading rates..."]}):R.label})]})})]})})}),V&&e.jsx(Fe,{isOpen:V,onClose:de,type:"withdraw",amount:oe,coinType:r}),e.jsx("style",{children:`
        /* ── Root ── */
        .withdraw-container {
          max-width: 400px;
          margin: 0 auto;
