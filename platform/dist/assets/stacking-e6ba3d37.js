import{v as d,Z as xa,q as s,p as m,y as ka,u as w,n as fa,ao as ha,E as ba,ap as ya,aq as U,F as q,j as e,ar as K}from"./index-e08889f7.js";import{u as ja,y as va,c as wa,F as Na}from"./FormErrors-4aa0e33f.js";import{y as f}from"./yupFormSchemas-42bb2957.js";import{F as Sa}from"./FieldFormItem-f43955e0.js";import{D as W}from"./Dates-02803235.js";import{S as Fa}from"./sucessModal-c9d05c37.js";import{u as Ra}from"./useDispatch-aefee968.js";import"./v4-4a60fe23.js";const g=t=>t.plan.list,za=d([g],t=>t.loading),Da=d([g],t=>t.exportLoading),C=d([g],t=>t.rows),M=d([g],t=>t.count),Ca=d([M],t=>t>0),Ma=d([g],t=>t.sorter||{}),Pa=d([g],t=>{const r=t.sorter;if(!r||!r.field)return null;let h=r.order==="descend"?"DESC":"ASC";return`${r.field}_${h}`}),Ta=d([g],t=>t.filter),Aa=d([g],t=>t.rawFilter),Ea=d([g],t=>t.pagination.pageSize),Ba=d([g],t=>{const r=t.pagination;return!r||!r.pageSize?0:((r.current||1)-1)*r.pageSize}),La=d([g,M],(t,r)=>({...t.pagination,total:r})),H=d([g],t=>t.selectedKeys),$a=d([g,C],(t,r)=>r.filter(h=>t.selectedKeys.includes(h.id))),Oa=d([C,H],(t,r)=>t.length===r.length),Va={selectLoading:za,selectRows:C,selectCount:M,selectOrderBy:Pa,selectLimit:Ea,selectFilter:Ta,selectOffset:Ba,selectPagination:La,selectSelectedKeys:H,selectSelectedRows:$a,selectHasRows:Ca,selectExportLoading:Da,selectRawFilter:Aa,selectIsAllSelected:Oa,selectSorter:Ma},N=t=>t.stacking.form,Ia=d([N],t=>t.record),Ua=d([N],t=>!!t.initLoading),qa=d([N],t=>!!t.saveLoading),Ka=d([N],t=>!!t.showModal),Wa={selectInitLoading:Ua,selectSaveLoading:qa,selectRecord:Ia,selectModal:Ka,selectRaw:N},Ha=xa().shape({user:f.relationToOne(s("entities.stacking.fields.user"),{}),plan:f.relationToOne(s("entities.stacking.fields.plan"),{}),amount:f.decimal(s("entities.stacking.fields.amount"),{required:!0}),status:f.enumerator(s("entities.stacking.fields.status"),{options:["active","completed","cancelled"]}),startDate:f.datetime(s("entities.stacking.fields.startDate"),{}),endDate:f.datetime(s("entities.stacking.fields.endDate"),{}),earnedRewards:f.decimal(s("entities.stacking.fields.earnedRewards"),{})});function ee(){const[t,r]=m.useState("options"),[h,P]=m.useState(!1),x=Ra(),Z=ka(),y=w(Va.selectRows),_=w(fa.selectCurrentUser),F=w(ha.selectRows),S=w(ba.selectRows),[R,G]=m.useState({}),[T,A]=m.useState({}),[J,Q]=m.useState(""),E=w(Wa.selectModal),X=()=>{x(K.doClose())},[c,Y]=m.useState({crypto:"",daily:"",balance:0,min:0,max:0,symbol:"",plan:"",unstakingPeriod:""}),[b,z]=m.useState(""),[aa]=m.useState(()=>({user:"",plan:"",amount:"",status:"",startDate:"",endDate:"",earnedRewards:""})),j=ja({resolver:va.yupResolver(Ha),mode:"all",defaultValues:aa}),B=wa({control:j.control,name:"amount",defaultValue:""}),ea=()=>{if(S&&S.length>0){const a=S.reduce((n,i)=>(i.symbol&&i.amount!==void 0&&(n[i.symbol]=parseFloat(i.amount)||0),n),{});A(a)}};m.useEffect(()=>{z(B||"")},[B]),m.useEffect(()=>{ea()},[S]);const sa=async a=>{a.startDate=new Date;const n=new Date(a.startDate);n.setDate(n.getDate()+parseInt(c.unstakingPeriod)),a.endDate=n.toISOString(),a.status="active",a.plan=c.plan,a.user=_.id,Q(a.amount);try{await x(K.doCreate(a)),x(q.doFetch()),x(U.doFetch()),A(i=>({...i,[c.symbol]:(i[c.symbol]||0)-parseFloat(b)})),L()}catch(i){console.error("Staking failed:",i)}},ta=()=>{if(!b||isNaN(b)||b<=0)return"0";const a=parseFloat(b),n=parseFloat(c.daily),i=parseFloat(c.unstakingPeriod);return(a*(n/100)*i).toFixed(6)},na=()=>{const a=parseFloat(b),n=T[c.symbol]||0;return isNaN(a)||a<=0?{isValid:!1,message:s("stake.enterAmount")}:a>n?{isValid:!1,message:s("stake.insufficientBalance")}:a<c.min?{isValid:!1,message:s("stake.minAmount",{min:c.min})}:a>c.max?{isValid:!1,message:s("stake.maxAmount",{max:c.max})}:{isValid:!0,message:s("stake.confirmStake")}},ia=(a,n,i,l,o,p,u,k)=>{Y({crypto:a,daily:n,balance:i,min:l,max:o,symbol:p,plan:u,unstakingPeriod:k}),P(!0),z(""),j.setValue("amount","")},L=()=>{P(!1),z(""),j.setValue("amount","")},oa=async()=>{try{const n=[...new Set(y.map(o=>o.currency))].map(async o=>{if(o==="USDT")return{currency:o,price:1};try{const u=await(await fetch(`https://api.binance.com/api/v3/ticker/price?symbol=${o}USDT`)).json();return{currency:o,price:parseFloat(u.price)}}catch{return{currency:o,price:0}}}),i=await Promise.all(n),l={};i.forEach(o=>{l[o.currency]=o.price}),G(l)}catch(a){console.error("Error fetching crypto prices:",a)}},D=F.filter(a=>a.status==="active"),v=F.filter(a=>a.status==="completed"),ca=()=>{let a=0;return D.forEach(n=>{var p;const i=(p=n==null?void 0:n.plan)==null?void 0:p.currency,l=parseFloat(n.amount)||0,o=R[i]||0;a+=l*o}),a.toFixed(2)},ra=()=>{let a=0;return F.forEach(n=>{var p;const i=(p=n==null?void 0:n.plan)==null?void 0:p.currency,l=parseFloat(n.earnedRewards)||0,o=R[i]||0;a+=l*o}),a.toFixed(2)},la=()=>{let a=0;return v.forEach(n=>{var p;const i=(p=n==null?void 0:n.plan)==null?void 0:p.currency,l=parseFloat(n.earnedRewards)||0,o=R[i]||0;a+=l*o}),a.toFixed(2)};m.useEffect(()=>(x(ya.doFetch()),x(U.doFetch()),x(q.doFetch()),()=>{}),[x]),m.useEffect(()=>{y.length>0&&oa()},[y]);const $=na(),O=!$.isValid,da=$.message,pa=a=>{const n=new Date,i=new Date(a.startDate);return Math.floor((n.getTime()-i.getTime())/(1e3*60*60*24))},ga=a=>{const n=new Date,i=new Date(a.endDate),l=Math.floor((i.getTime()-n.getTime())/(1e3*60*60*24));return Math.max(0,l)},ma=()=>T[c.symbol]||0,ua=()=>Z.goBack();return e.jsxs("div",{className:"stacking-page",children:[e.jsxs("div",{className:"top-header",children:[e.jsx("div",{className:"back-button",onClick:ua,children:e.jsx("i",{className:"fas fa-arrow-left"})}),e.jsx("h1",{className:"page-title",children:s("pages.staking.title")}),e.jsx("div",{className:"header-placeholder"})]}),e.jsxs("div",{className:"stacking-card",children:[e.jsxs("div",{className:"stacking-overview",children:[e.jsx("div",{className:"stacking-label",children:s("pages.staking.totalStakedBalance")}),e.jsxs("div",{className:"stacking-balance",children:["$",ca()]}),e.jsxs("div",{className:"stacking-rewards-earned",children:["+ $",ra()," ",s("pages.staking.earned")]})]}),e.jsx("div",{className:"stacking-toggle-section",children:["options","active","completed"].map(a=>e.jsx("div",{className:`stacking-toggle-option ${t===a?"stacking-toggle-active":""}`,onClick:()=>r(a),children:s(`pages.staking.tabs.${a}`)},a))}),t==="options"&&e.jsx("div",{className:"stacking-options",children:y.length>0?y.map(a=>e.jsxs("div",{className:"stacking-option-card",children:[e.jsxs("div",{className:"stacking-option-header",children:[e.jsxs("div",{className:"option-coin-info",children:[e.jsx("img",{src:`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${a.currency}.png`,alt:a.currency}),e.jsx("span",{className:"stacking-option-name",children:a.currency})]}),e.jsxs("div",{className:"stacking-option-apy",children:[a.dailyRate,"% ",s("pages.staking.daily")]})]}),e.jsxs("div",{className:"stacking-option-details",children:[e.jsx("span",{className:"stacking-detail-label",children:s("pages.staking.minimumStake")}),e.jsxs("span",{className:"stacking-detail-value",children:[a.minimumStake," ",a.currency]})]}),e.jsxs("div",{className:"stacking-option-details",children:[e.jsx("span",{className:"stacking-detail-label",children:s("pages.staking.unstakingPeriod")}),e.jsxs("span",{className:"stacking-detail-value",children:[a.unstakingPeriod," ",s("pages.staking.days")]})]}),e.jsx("button",{className:"stacking-stake-button",onClick:()=>ia(a.currency,a.dailyRate,a.earnedRewards,a.minimumStake,a.maxStake,a.currency,a.id,a.unstakingPeriod),children:s("pages.staking.stakeButton",a.currency)})]},a.currency)):e.jsxs("div",{className:"empty-stacking-state",children:[e.jsx("i",{className:"fas fa-coins empty-icon"}),e.jsx("div",{className:"empty-title",children:s("pages.staking.emptyStates.options.title")}),e.jsx("div",{className:"empty-message",children:s("pages.staking.emptyStates.options.message")})]})}),t==="active"&&e.jsx("div",{className:"stacking-active-stakes",children:D.length>0?D.map(a=>{var l,o,p,u,k,V,I;const n=Math.min(100,pa(a)/((l=a==null?void 0:a.plan)==null?void 0:l.unstakingPeriod)*100),i=ga(a);return e.jsxs("div",{className:"stacking-stake-item",children:[e.jsxs("div",{className:"stacking-stake-header",children:[e.jsxs("div",{className:"stake-coin-info",children:[e.jsx("img",{src:`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${(o=a==null?void 0:a.plan)==null?void 0:o.currency}.png`,alt:(p=a==null?void 0:a.plan)==null?void 0:p.currency}),e.jsx("span",{className:"stacking-stake-crypto",children:(u=a==null?void 0:a.plan)==null?void 0:u.currency}),e.jsx("span",{className:"stacking-status-badge stacking-status-active",children:s("pages.staking.status.active")})]}),e.jsxs("span",{className:"stacking-stake-amount",children:[a.amount," ",(k=a==null?void 0:a.plan)==null?void 0:k.currency]})]}),e.jsxs("div",{className:"stacking-stake-details",children:[e.jsx("span",{className:"stacking-stake-label",children:s("pages.staking.daily")}),e.jsxs("span",{className:"stacking-stake-value",children:[(V=a==null?void 0:a.plan)==null?void 0:V.dailyRate,"%"]})]}),e.jsxs("div",{className:"stacking-stake-details",children:[e.jsx("span",{className:"stacking-stake-label",children:s("pages.staking.earned")}),e.jsxs("span",{className:"stacking-stake-value stacking-value-positive",children:[a.earnedRewards||0," ",(I=a==null?void 0:a.plan)==null?void 0:I.currency]})]}),e.jsxs("div",{className:"stacking-stake-details",children:[e.jsx("span",{className:"stacking-stake-label",children:s("pages.staking.remaining")}),e.jsxs("span",{className:"stacking-stake-value",children:[i," ",s("pages.staking.days")]})]}),e.jsx("div",{className:"stacking-progress-bar",children:e.jsx("div",{className:"stacking-progress-fill",style:{width:`${n}%`}})})]},a.id)}):e.jsxs("div",{className:"empty-stacking-state",children:[e.jsx("i",{className:"fas fa-chart-line empty-icon"}),e.jsx("div",{className:"empty-title",children:s("pages.staking.emptyStates.active.title")}),e.jsx("div",{className:"empty-message",children:s("pages.staking.emptyStates.active.message")}),e.jsx("button",{className:"start-staking-button",onClick:()=>r("options"),children:s("pages.staking.exploreStakingOptions")})]})}),t==="completed"&&e.jsx("div",{className:"stacking-completed-stakes",children:v.length>0?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"completed-rewards-overview",children:[e.jsxs("div",{className:"completed-rewards-header",children:[e.jsx("span",{className:"completed-rewards-label",children:s("pages.staking.totalCompletedRewards")}),e.jsxs("span",{className:"completed-rewards-count",children:[v.length," ",v.length===1?s("pages.staking.stake"):s("pages.staking.stakes")]})]}),e.jsxs("div",{className:"completed-rewards-amount",children:["$",la()]}),e.jsx("div",{className:"completed-rewards-subtext",children:s("pages.staking.allRewardsFromCompleted")})]}),v.map(a=>{var n,i,l,o,p,u,k;return e.jsxs("div",{className:"stacking-completed-item",children:[e.jsxs("div",{className:"stacking-stake-header",children:[e.jsxs("div",{className:"stake-coin-info",children:[e.jsx("img",{src:`https://images.weserv.nl/?url=https://bin.bnbstatic.com/static/assets/logos/${(n=a==null?void 0:a.plan)==null?void 0:n.currency}.png`,alt:(i=a==null?void 0:a.plan)==null?void 0:i.currency}),e.jsx("span",{className:"stacking-stake-crypto",children:(l=a==null?void 0:a.plan)==null?void 0:l.currency}),e.jsx("span",{className:"stacking-status-badge stacking-status-completed",children:s("pages.staking.status.completed")})]}),e.jsxs("span",{className:"stacking-stake-amount",children:[a.amount," ",(o=a==null?void 0:a.plan)==null?void 0:o.currency]})]}),e.jsxs("div",{className:"stacking-stake-details",children:[e.jsx("span",{className:"stacking-stake-label",children:s("pages.staking.dailyRate")}),e.jsxs("span",{className:"stacking-stake-value",children:[(p=a==null?void 0:a.plan)==null?void 0:p.dailyRate,"%"]})]}),e.jsxs("div",{className:"stacking-stake-details",children:[e.jsx("span",{className:"stacking-stake-label",children:s("pages.staking.duration")}),e.jsxs("span",{className:"stacking-stake-value",children:[(u=a==null?void 0:a.plan)==null?void 0:u.unstakingPeriod," ",s("pages.staking.days")]})]}),e.jsxs("div",{className:"stacking-stake-details",children:[e.jsx("span",{className:"stacking-stake-label",children:s("pages.staking.createdAt")}),e.jsx("span",{className:"stacking-stake-value",children:W.NewsDate(a==null?void 0:a.startDate)})]}),e.jsxs("div",{className:"stacking-stake-details",children:[e.jsx("span",{className:"stacking-stake-label",children:s("pages.staking.dateFinish")}),e.jsx("span",{className:"stacking-stake-value",children:W.NewsDate(a==null?void 0:a.endDate)})]}),e.jsxs("div",{className:"stacking-completed-rewards",children:[e.jsx("div",{className:"stacking-completed-rewards-label",children:s("pages.staking.totalRewardsEarned")}),e.jsxs("div",{className:"stacking-completed-rewards-amount",children:["+",a.earnedRewards||0," ",(k=a==null?void 0:a.plan)==null?void 0:k.currency]})]})]},a.id)})]}):e.jsxs("div",{className:"empty-stacking-state",children:[e.jsx("i",{className:"fas fa-check-circle empty-icon"}),e.jsx("div",{className:"empty-title",children:s("pages.staking.emptyStates.completed.title")}),e.jsx("div",{className:"empty-message",children:s("pages.staking.emptyStates.completed.message")}),e.jsx("button",{className:"start-staking-button",onClick:()=>r("options"),children:s("pages.staking.startStaking")})]})})]}),E&&e.jsx(Fa,{isOpen:E,onClose:X,type:"staking",amount:String(J),coinType:c.crypto}),h&&e.jsx("div",{className:"staking-modal-overlay",children:e.jsx("div",{className:"staking-modal-content",children:e.jsx(Na,{...j,children:e.jsxs("form",{onSubmit:j.handleSubmit(sa),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("h3",{children:[s("pages.staking.stakeModal.title")," ",c.crypto]}),e.jsx("button",{type:"button",className:"modal-close",onClick:L,children:e.jsx("i",{className:"fas fa-times"})})]}),e.jsxs("div",{className:"modal-body",children:[e.jsxs("div",{className:"staking-input-group",children:[e.jsx(Sa,{name:"amount",label:s("pages.staking.stakeModal.amountToStake"),className:"textField",className1:"inputField",className2:"inputLabel",className3:"inputWrapper",placeholder:s("pages.staking.stakeModal.enterAmount")}),e.jsxs("div",{className:"balance-info",children:[s("pages.staking.balance"),":"," ",ma()," ",c.symbol]})]}),e.jsxs("div",{className:"staking-modal-details",children:[e.jsxs("div",{className:"detail-line",children:[e.jsx("span",{children:s("pages.staking.daily")}),e.jsxs("span",{children:[c.daily,"%"]})]}),e.jsxs("div",{className:"detail-line",children:[e.jsx("span",{children:s("pages.staking.minimumStake")}),e.jsxs("span",{children:[c.min," ",c.symbol]})]}),e.jsxs("div",{className:"detail-line",children:[e.jsx("span",{children:s("pages.staking.maximumStake")}),e.jsxs("span",{children:[c.max," ",c.symbol]})]}),e.jsxs("div",{className:"detail-line",children:[e.jsx("span",{children:s("pages.staking.estimatedTotalRewards")}),e.jsxs("span",{children:[ta()," ",c.symbol]})]})]})]}),e.jsx("div",{className:"modal-footer",children:e.jsx("button",{type:"submit",disabled:O,className:`stake-submit-btn ${O?"disabled":""}`,children:da})})]})})})}),e.jsx("style",{children:`
        /* ====== Page Layout ====== */
        .stacking-page {
          min-height: 100vh;
          background: #0e0f14;
