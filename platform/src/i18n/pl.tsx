const pl = {
  ...
  pages: {
    ...
    home: {
      hero: {
        subtitle: "Kupuj, sprzedawaj i zarządzaj ponad 100 kryptowalutami dzięki rynkom w czasie rzeczywistym, niskim opłatom i bezpieczeństwu na poziomie bankowym.",
        cta: "Zacznij handlować"
      },
      quickAccess: {
        title: "Szybki Dostęp",
        deposit: "Wpłata",
