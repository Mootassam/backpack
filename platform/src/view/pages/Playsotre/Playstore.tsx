...
function Playstore() {
  ...
  const screenshots = [
    { src: "/playsotre/1.png", label: "Advanced Charts" },
    { src: "/playsotre/2.jpg", label: "Fast Withdrawals" },
    { src: "/playsotre/3.jpg", label: "Crypto Staking" },
    { src: "/playsotre/4.jpg", label: "Portfolio" },
    { src: "/playsotre/5.jpg", label: "Market" },
    { src: "/playsotre/6.jpg", label: "Future Trade" },

    { src: "/playsotre/5.png", label: "24/7 Support" }
  ]
